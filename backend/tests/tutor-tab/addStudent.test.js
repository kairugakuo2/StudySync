...
const { __test } = require('../../src/features/tutor-tab/tutorController');
const { addStudentLogic: addStudent, listStudentsLogic: getStudents, reset: resetStudents 
...
describe('addStudent(name)', () => {
    ...
    test('Correct: adds a normal name and returns the record', () => {
        const s = addStudent('Alice Johnson');
